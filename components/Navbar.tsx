            ...
            <div className="hidden md:flex flex-1 max-w-xl items-center">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2 border border-slate-300 rounded-full bg-slate-50 focus:bg-white focus:ring-2 focus:ring-brand-primary focus:border-transparent transition-all duration-300 text-slate-900"
                  value={searchTerm}
